...
When requirements, constraints, or tradeoffs are ambiguous:
1. Classify as BLOCKING or NON-BLOCKING (stated assumption)
2. Use `socratic-design` skill
3. Return one tagged question — `## Blocker:` or `## Note: (assumed: ...)`
4. For non-blocking: continue design with stated assumption
...
- **Frontend**: Angular modern (v20+)
- **Backend**: Dotnet (C# / .NET modern)
- **Database**: PostgreSQL (Supabase)
- **AI**: OpenCode with structured output
...
- **100K users**: Current architecture sufficient
