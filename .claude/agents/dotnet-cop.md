...
3. **Load the `dotnet-cop` skill before reviewing.** You MUST load `skills/dotnet-cop/SKILL.md`, then `skills/dotnet-cop/enforcement.md` (always), then the file-type sub-pages for each changed file. Skipping enforcement.md is a contract violation.
