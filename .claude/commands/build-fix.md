...
> CC: delegate this to the `build-error-resolver` subagent via the Agent tool (subagent_type: `build-error-resolver`). The subagent inspects the repo and runs the steps below.
