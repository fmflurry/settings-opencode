...
> CC: delegate this to the `refactor-cleaner` subagent via the Agent tool (subagent_type: `refactor-cleaner`). The subagent inspects the repo and runs the steps below.
