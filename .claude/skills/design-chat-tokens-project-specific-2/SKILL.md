---
name: "design-chat-tokens-project-specific-2"
description: "Use this pattern when handling recurring project specific workflows."
version: "1.0.0"
source: "continuous-learning"
status: "review-required"
learned_from: "skills/learned/design-chat-tokens-project-specific-2.draft.md"
title: "Project-Specific Convention Pattern"
signature: "f011955bac94"
...
## Examples
- assistant: I’m rewriting the local unpushed `WIP` commit by folding in these chat layout fixes and replacing it with a conventional commit message.
- - `eslint`
