...
| **AutoMapper profile defined outside `Infrastructure/Mapping/`** | `Profile` subclass in `Core/` or `Application/` | Mapping between EF entities and domain models belongs to Infrastructure; placing it elsewhere bleeds infra knowledge outward |
