---
name: infrastructure-exception-goal-project-specific
title: Project-Specific Convention Pattern
signature: 9508186ef088
version: 1.0.0
source: continuous-learning
category: project_specific
status: review-required
session_id: ses_35d121db7ffezRaTjHr9HKO26N
message_count: 42
...
## Examples
- Your ultimate goal is to create an OpenCode SKILL that we can reuse to mimic this architecture.
- The goal of this repository is to implement CLean Architecture layers (Application / Core / Infrastructure), and use Hexagonal Architecture (port/adapter) to...
